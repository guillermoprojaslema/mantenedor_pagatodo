...
class Cobro extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['empresa_id', 'servicio_id', 'moneda_id', 'parent_id', 'cliente_cedula', 'cliente_numero', 'fecha_emision', 'fecha_vencimiento', 'valor_minimo', 'valor_total', 'valor_multa', 'tipo', 'numero_boleta_factura', 'cliente_nombre', 'extras', 'validador', 'datos_visa', 'obligatoria', 'created_at', 'updated_at', 'deleted_at'];
